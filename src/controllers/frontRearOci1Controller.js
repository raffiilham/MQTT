...
class FrontRearOci1Controller {
    ...
    async processData(inspectionDataArray) {
        logger.info(`[${this.machineName}] Processing ${inspectionDataArray.length} data records.`);
        await this.opcuaService.saveRejectFrontRear(inspectionDataArray, this.machineName)

        console.log("================ OCI 1 ================");
        console.log(inspectionDataArray);
        console.log("=======================================");
    }
}
